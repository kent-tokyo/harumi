...
fn e2e_write_output_pdf() {
    ...
    doc.page(1).unwrap().add_invisible_text_runs(&[
        TextRun { text: "晴海ライブラリ".into(), font: fh, x: 72.0, y: 750.0, font_size: 14.0, render_mode: 3, color: [0.0; 3] },
        TextRun { text: "日本語のPDF検索".into(), font: fh, x: 72.0, y: 720.0, font_size: 12.0, render_mode: 3, color: [0.0; 3] },
        TextRun { text: "純Rust製・CJK対応".into(), font: fh, x: 72.0, y: 690.0, font_size: 12.0, render_mode: 3, color: [0.0; 3] },
    ]).unwrap();
